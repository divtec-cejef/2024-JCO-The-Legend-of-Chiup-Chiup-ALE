...
Q_CONSTINIT const QMetaObject GameScene::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSGameSceneENDCLASS_t,
        ...
        // method 'spriteAddedToScene'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<Sprite *, std::false_type>,
        // method 'spriteRemovedFromScene'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<Sprite *, std::false_type>,
        // method 'onSpriteDestroyed'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<Sprite *, std::false_type>
    >,
    nullptr
...
void GameScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->spriteAddedToScene((*reinterpret_cast< std::add_pointer_t<Sprite*>>(_a[1]))); break;
        case 1: _t->spriteRemovedFromScene((*reinterpret_cast< std::add_pointer_t<Sprite*>>(_a[1]))); break;
        case 2: _t->onSpriteDestroyed((*reinterpret_cast< std::add_pointer_t<Sprite*>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &GameScene::spriteAddedToScene; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (GameScene::*)(Sprite * );
            if (_t _q_method = &GameScene::spriteRemovedFromScene; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
